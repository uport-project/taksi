...
npx lerna publish --conventional-commits --conventional-prerelease --force-publish --canary --preid beta --pre-dist-tag latest --create-release github --tag-version-prefix 'pre' --yes
