...
npx lerna publish --conventional-prerelease --force-publish --canary --no-git-reset --create-release github --tag-version-prefix 'pre' --preid beta --pre-dist-tag beta --yes
